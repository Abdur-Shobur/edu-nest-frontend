...
import { useBrandDeleteMutation, useBrandStatusMutation } from './api-slice';
...
const DropDownAction = ({ item }: { item: IBrand }) => {
	const [mutation, { isLoading }] = useBrandDeleteMutation();
