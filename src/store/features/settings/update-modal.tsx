...
import { IBrandStatus, ISettings, ISettingsStatus } from './type';
...
//  Component
export function UpdateModal({ data }: { data: ISettings }) {
...
const FORM = ({
	...
	const [mutation, { isLoading }] = useSettingsUpdateMutation();
	...
	const form = useForm<ZodType>({
		...
		defaultValues: {
			...
			slug: editData.slug,
			status:
				editData.status === ISettingsStatus.Trashed
