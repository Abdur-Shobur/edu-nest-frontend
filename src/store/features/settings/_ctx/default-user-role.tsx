...
import { useSettingsUpdateMutation } from '../api-slice';
import { ISettings } from '../type';

export function DefaultUserRole({ data }: { data: ISettings }) {
	...
	const [mutation, { isLoading: isLoadingStore }] = useSettingsUpdateMutation();
