...
import { useBlogCategoryUpdateMutation } from './api-slice';
import { IBlogCategory, IBlogCategoryStatus } from './type';
...
//  Component
export function UpdateModal({ data }: { data: IBlogCategory }) {
	...
	return (
		<Dialog open={open} onOpenChange={setOpen}>
			...
			>
				<DialogHeader>
					<DialogTitle>Update BlogCategory</DialogTitle>
				</DialogHeader>
...
const FORM = ({
	...
	editData: IBlogCategory;
}) => {
	const [mutation, { isLoading }] = useBlogCategoryUpdateMutation();
	...
	const form = useForm<ZodType>({
		...
		defaultValues: {
			...
			slug: editData.slug,
			status:
				editData.status === IBlogCategoryStatus.Trashed
					? IBlogCategoryStatus.Inactive
					: editData.status,
		},
	});
			...
			<form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
				...
				<DialogFooter>
					<Button type="submit" disabled={isLoading}>
						...
						{isLoading ? 'Updating...' : 'Update BlogCategory'}
					</Button>
				</DialogFooter>
			</form>
		</Form>
