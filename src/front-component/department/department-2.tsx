...
const Department1: React.FC = () => {
	return (
		<div className="department-area py-120">
				...
				<div className="row">
					...
					<div className="col-lg-3">
						<div className="department-item wow fadeInUp" data-wow-delay=".50s">
							...
							<div className="department-info">
								<h4 className="department-title">
									<a href="academic-single.html">Information Technology</a>
								</h4>
								<p>
									There are many variations of passages the majority have some
									injected humour.
					...
					<div className="col-lg-3">
						<div className="department-item wow fadeInUp" data-wow-delay=".75s">
							...
							<div className="department-info">
								<h4 className="department-title">
									<a href="academic-single.html">Acting And Drama</a>
								</h4>
								<p>
									There are many variations of passages the majority have some
									injected humour.
					...
					<div className="col-lg-3">
						<div className="department-item wow fadeInUp" data-wow-delay="1s">
							...
							<div className="department-info">
								<h4 className="department-title">
									<a href="academic-single.html">Human Resource</a>
								</h4>
								<p>
									There are many variations of passages the majority have some
									injected humour.
